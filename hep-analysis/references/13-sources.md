...
| Alpha Magnetic Spectrometer (AMS-02) | NASA and AMS collaboration mission/science pages (exact URL not pinned here - verify current link before citing); `ams02.space/detector` and `ams02.space/advances-data-analysis` checked directly 2026-09-10 | Official mission overview for the AMS-02 case study in reference 40; check any specific instrument parameter or published result against an AMS collaboration publication before quoting it. The 2019-2020 EVA cooling-system repair is independently corroborated by NASA/Scientific American/phys.org/NASASpaceflight.com reporting; subsystem numeric specs (RICH radiator configuration, ACC efficiency, tracker/ECAL resolution) are website-sourced only as of the 2026-09-10 check and still need checking against the primary instrument publication before being quoted as measured fact. This is a live-changing fact set (further servicing/upgrades are plausible) - re-verify before reuse past this date. |
