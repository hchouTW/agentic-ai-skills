...
- [ ] P01/P08/P10 are PARTIAL on Haiku: RDataFrame `Runs`-tree sumw code (ref 03), units on the flux value (ref 35), and the cutoff safety factor plus backtracing (ref 35). Check whether the references state these clearly enough.
