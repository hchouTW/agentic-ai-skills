...
- [~] (2026-09-21: the 20+20 queries are written in `tests/prompts.md`; the run itself is still open) Trigger test for the frontmatter `description`: 20 should-trigger and 20 should-not-trigger queries. Near-misses:
