...
REQUIRED_PATHS = [
    ...
    "examples/05-trajectory-generic-verb-vs-domain-specific-rule.md",
    "examples/06-trajectory-clean-no-match-proceed-normally.md",
    "examples/07-gated-pipeline-adding-a-new-rule.md",
    "examples/08-gated-pipeline-disambiguating-figure-interpretation.md",
    "examples/09-gated-pipeline-expanding-a-carve-out.md",
    "examples/10-decision-tree-multi-skill-ambiguous-routing.md",
    "examples/11-decision-tree-figure-interpretation-routing.md",
    "examples/12-decision-tree-multiple-false-positive-keywords.md",
    "examples/13-elicitation-new-skill-request.md",
    "examples/14-elicitation-two-skills-request.md",
    "examples/15-elicitation-router-edge-case-request.md",
    "examples/16-adversarial-audit-new-routing-rule-proposal.md",
    "examples/17-adversarial-audit-fallback-text-proposal.md",
    "examples/18-adversarial-audit-bullet-consolidation-proposal.md",
    "examples/19-test-first-routing-parser-primary-secondary.md",
    "examples/20-test-first-sibling-discovery-invariant.md",
    "examples/21-test-first-bundle-validator-message-invariant.md",
    "examples/22-postmortem-missing-carve-out-hijack.md",
    "examples/23-postmortem-frontmatter-length-truncation.md",
    "examples/24-postmortem-generic-verb-double-routing.md",
]
