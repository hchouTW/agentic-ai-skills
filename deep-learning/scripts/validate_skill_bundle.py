...
REQUIRED_PATHS = [
    ...
    "references/geometric-and-equivariant-learning.md",
    "references/interpretability-and-explainability.md",
    "references/mixed-precision.md",
    "references/monitoring-and-lifecycle.md",
    "references/optimization-and-training-dynamics.md",
    "references/parallelism-strategy.md",
    ...
    "references/serving-architecture.md",
    "references/sequence-models.md",
    "references/tensor-shapes.md",
    "references/training-at-scale.md",
    ...
    "assets/metrics.py",
    "assets/models.py",
    "assets/dataset_splits.example.json",
    "assets/eval_runs.example.json",
    "assets/scaling_plan.example.json",
    ...
    "scripts/estimate_compute_budget.py",
    "scripts/estimate_training_memory.py",
    "scripts/serving_capacity.py",
